...
public class PaymentEventsPublisher {
	...
	public void paymentPrepareAccepted(String orderId, Object envelope) throws Exception {
	...
	public void paymentPrepared(String orderId, Object envelope) throws Exception {
		String payload = om.writeValueAsString(envelope);
		var msg = MessageBuilder.withPayload(payload)
			.setHeader(KafkaHeaders.TOPIC, payment)
			.setHeader(KafkaHeaders.KEY, orderId)
	...
	public void paymentResult(String orderId, Object envelope) throws Exception {
		String payload = om.writeValueAsString(envelope);
		var msg = MessageBuilder.withPayload(payload)
			.setHeader(KafkaHeaders.TOPIC, payment)
			.setHeader(KafkaHeaders.KEY, orderId)
	...
	public void paymentFailed(String orderId, Object envelope) throws Exception {
		String payload = om.writeValueAsString(envelope);
		var msg = MessageBuilder.withPayload(payload)
			.setHeader(KafkaHeaders.TOPIC, payment)
			.setHeader(KafkaHeaders.KEY, orderId)
